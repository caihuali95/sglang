...
class ServerArgs:
    ...
    enable_unified_memory: A[
        ...
        "backends; not yet compatible with PD disaggregation.",
    ] = False
    ...
    def _handle_page_major_kv_layout(self):
        ...
        # The draft backend must be listed. The draft factory picks it FIRST
        # when set. So a non-Triton draft backend would otherwise write its
