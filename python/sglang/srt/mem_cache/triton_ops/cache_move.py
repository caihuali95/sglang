...
# ---------------------------------------------------------------------------
# store_cache_4d — single-launch Triton write into the 4-D page-local envelope
...
def store_cache_4d(
    ...
    """One-launch Triton write into the 4-D page-local envelope K/V views.
    ...
    # contiguous. This holds for the page-local envelope views
