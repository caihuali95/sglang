...
class ModelRunner:
    ...
    def init_kv_index_source(self):
        """The read-path id-space choke point: attention backends build their
        kv_indices / page tables from its per-batch view instead of probing
        the allocator's id spaces themselves."""
        self.kv_index_source = KVIndexSource(
