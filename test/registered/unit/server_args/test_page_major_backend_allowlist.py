...
exposes DENSE per-layer views and nothing else:
  ...
  * plain `--enable-page-major-kv-layout` without the unified pool is
    temporarily rejected at boot (the strided views were removed; the
    dense-view reimplementation is pending).
